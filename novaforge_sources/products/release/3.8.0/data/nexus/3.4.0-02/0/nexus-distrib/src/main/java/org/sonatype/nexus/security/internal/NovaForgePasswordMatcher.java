 ...
 * 
 */
public class NovaForgePasswordMatcher extends PasswordMatcher
{
  ...
  public boolean doCredentialsMatch(AuthenticationToken token, AuthenticationInfo info)
  {
    ...
    {
      submittedPassword = new Sha1Hash(new String((char[]) submittedPassword)).toString();
    }
    ...
    return getPasswordService().passwordsMatch(submittedPassword, formatted);
  }
